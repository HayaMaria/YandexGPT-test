...
- API-ключ Yandex Cloud для доступа к нейросети. (Подробнее в файле ???)
...
- В secrets.json пользователь вставляет свой ключ Yandex Cloud (Подробнее в файле ???). 
...
- В ID_folder.txt нужно вставить адресную строку вашего фолдера. (Подробнее в файле ???) 
  - Пример: https://console.yandex.cloud/folders/b1g82u1r09dr8pd
